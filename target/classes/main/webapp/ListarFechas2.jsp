    ...
    <body>
        <table border="1">
            ...
            <thead>
                ...
                <%
                    String fecha_entrega1 = (String) request.getSession().getAttribute("fecha_entrega1");
                    String fecha_entrega2 = (String) request.getSession().getAttribute("fecha_entrega2");
                    String usu = (String) request.getSession().getAttribute("usu");
